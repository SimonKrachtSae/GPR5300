...
{
    //For further information:https://de.wikipedia.org/wiki/Blinn-Beleuchtungsmodell
    ...
    //cos0 = L * N
    float cosine = dot(normal, pointToLightPos);

    //Ispecular = Ia * Kambient * cos0
    //Kspecular = specular of material
    float4 lightSpecular = lightIntensity * matSpecular * pow(abs(cosine), surfaceTex);
